		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "New Project Requisition",
									"targetURL": "#inprotivitinewprojectrequisition-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inprotivitinewprojectrequisition-display": {
								"semanticObject": "inprotivitinewprojectrequisition",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.protiviti.newprojectrequisition",
									"url": sap.ui.require.toUrl("in/protiviti/newprojectrequisition")
								}
							}
						}
					}
