		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RMG Dashboard",
									"targetURL": "#rmgrmgdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rmgrmgdashboard-display": {
								"semanticObject": "rmgrmgdashboard",
								"action": "display",
								"description": "RMG Dashboard",
								"title": "RMG Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rmg.rmgdashboard",
									"url": sap.ui.require.toUrl("rmg/rmgdashboard")
								}
							}
						}
					}
