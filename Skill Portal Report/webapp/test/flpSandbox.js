		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comzskrepzskillreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzskrepzskillreport-display": {
								"semanticObject": "comzskrepzskillreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zskrep.zskillreport",
									"url": sap.ui.require.toUrl("com/zskrep/zskillreport")
								}
							}
						}
					}
