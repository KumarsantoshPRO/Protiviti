		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comzspskillportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzspskillportal-display": {
								"semanticObject": "comzspskillportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zsp.skillportal",
									"url": sap.ui.require.toUrl("com/zsp/skillportal")
								}
							}
						}
					}
